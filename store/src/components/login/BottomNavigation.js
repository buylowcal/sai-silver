  ...
  return (
    <>
        ...
        <div className="flex flex-col mb-4">
          {data?.google_login_status && (
            <button
              ...
              className={
                buttonStyles + "bg-white text-gray-800 font-sans space-x-2 border border-2 shadow-md"
              }
            >
      ...
      <div className="text-center text-base text-gray-900 mt-4">
        <div className="text-gray-400 font-sans tracking-wider font-thin  mt-2.5">
          {desc ? "Already have an account?" : "Don't have an account?"}
          <Link
            href={route}
            className="text-gray-800 hover:text-[#ff6b01] text-base tracking-wider font-bold mx-2"
          >
