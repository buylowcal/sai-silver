...
export const DirectionAwareHover = ({
  ...
  return (
    ( <motion.div
      ...
      ref={ref}
      className={cn(
        " bg-transparent border w-auto rounded-lg mx-3 overflow-hidden group/card relative",
        className
      )}
    >
      <AnimatePresence mode="wait">
        <motion.div
          ...
          <motion.div
            ...
            className={cn("text-white uppercase  tracking-widest font-semibold absolute bottom-4 left-4 z-40", childrenClassName)}>
            {children}
          </motion.div>
        </motion.div>
      </AnimatePresence>
