  ...
  return (
    <div className="min-h-screen flex flex-col items-center">
      ...
      <div className="relative w-full overflow-hidden">
        <div className="absolute w-1/4 h-full left-0 z-50 bg-gradient-to-r from-gray-200 to-transparent"></div>
        <div className="absolute w-1/4 h-full right-0 z-50 bg-gradient-to-l from-gray-200 to-transparent"></div>
            ...
            >
              <div className="relative w-full h-80">
                ...
                {playingIndex !== index && (
                  ...
                  >
                    <svg
                      className="h-14 w-14 text-white bg-gray-400 rounded-full bg-clip-padding backdrop-filter backdrop-blur-md text-center p-2 bg-opacity-10 "
                      fill="currentColor"
                      viewBox="0 0 20 20"
