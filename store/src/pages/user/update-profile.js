                    ...
                    <div className="col-span-6 sm:col-span-3 mt-5 text-right">
                      {loading ? (
                        ...
                        <button
                          disabled={loading}
                          type="submit"
                          className="md:text-sm leading-5 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-medium text-center justify-center border-0 border-transparent rounded-md placeholder-white focus-visible:outline-none focus:outline-none bg-[#ff6b01] text-white px-5 md:px-6 lg:px-8 py-2 md:py-3 lg:py-3  hover:bg-emerald-600 h-12 mt-1 text-base lg:text-base w-full sm:w-auto tracking-widest"
                        >
                          {showingTranslateValue(
